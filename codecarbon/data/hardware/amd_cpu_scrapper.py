    ...
    try:
        ...
        for selector in reject_button_selectors:
            try:
                ...
                if await button.is_visible(timeout=2000): # Short timeout for visibility check
        ...
        if reject_button:
            ...
            print("Cookie banner 'Reject All' button not found or not visible after trying common selectors.")
...
async def download_csv_from_url(page: Page, url: str, output_filename: str):
    ...
    try:
        ...
        async with page.expect_download(timeout=30000) as download_info: # Increased timeout for download
