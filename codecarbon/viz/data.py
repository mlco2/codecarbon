...
class Data:
    ...
    def get_experiment_summary(experiment_data: List[Dict]):
        ...
        experiment_summary = {
            ...
            "total": {
                "duration": sum(
                    map(lambda experiment: experiment["duration"], experiment_data)
                ),
                "emissions": sum(
                    map(lambda experiment: experiment["emissions"], experiment_data)
                ),
                "energy_consumed": sum(
                    map(lambda experiment: experiment["energy_consumed"], experiment_data)
                ),
            },
