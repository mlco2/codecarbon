...
![Summary](./_images/summary.png){.align-center width="700px"
height="400px"}
...
![Global Equivalents](./_images/global_equivalents.png){.align-center
...
![Cloud Emissions](./_images/cloud_emissions.png){.align-center
...
![Summary](./_images/codecarbon-API-dashboard.png){.align-center
width="750px"}
...
![experiment and run](./_images/Experiment-run.png){.align-center
width="750px"}
...
![run time series and metadata](./_images/run&metadata.png){.align-center
width="750px"}
...
![carbon intensity carbon_map](./_images/carbon_map.png){.align-center
width="750px"}
