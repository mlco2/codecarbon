...
CodeCarbon provides emissions data that you can use with various carbon offset programs. Check our [examples](./examples/) for integration patterns.
...
Yes. See our [Advanced Installation](./advanced_installation/) guide for Docker setup.
