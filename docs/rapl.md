...
5.  **DRAM exclusion**: By default (`include_dram=False`), don\'t adds
...
![RAPL Example](https://hubblo-org.github.io/scaphandre-documentation/explanations/rapl.png){.align-center
width="600px"}
