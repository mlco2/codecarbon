...
class TestApplePowerMetrics:
    ...
    def test_get_details_without_samples(self, mock_setup, mock_log_values, tmp_path):
        ...
        with mock.patch("codecarbon.core.powermetrics.logger.warning") as warning:
            ...
            powermetrics.get_details()

        # THEN the silent 0 W is flagged, once per tracker, not once per measure.
