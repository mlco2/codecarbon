    ...
    <>
      <main className="flex min-h-[100dvh] flex-col items-center justify-center bg-background px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto text-center">
          ...
          <div className="mt-6">
            <a
              href={`${import.meta.env.VITE_API_URL}/auth/login?redirect=${import.meta.env.VITE_BASE_URL}/home?auth=true`}
            >
      ...
      <footer className="mx-auto text-center mb-4 text-sm text-muted-foreground space-y-2">
        <p>
          ...
          <a href="https://codecarbon.io" className="text-primary underline">
            codecarbon.io
          </a>
          .
        </p>
