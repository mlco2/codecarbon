    ...
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground">
          CodeCarbon collects computing emissions data that you explicitly
          submit through our tracking tools. This includes energy consumption
          metrics, hardware information, and geographic region data used to
