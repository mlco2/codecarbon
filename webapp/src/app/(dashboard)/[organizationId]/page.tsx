...
export const description =
  "A dashboard of agregated data for the organization.";
...
async function getOrganization(orgId: string): Promise<Organization | null> {
  try {
    const res = await fetch(`${process.env.API_URL}/organizations/${orgId}`, {
    ...
    <div className="h-full w-full overflow-auto">
      ...
      {organization && (
        <main className="flex flex-col gap-4 p-4 md:gap-8 md:p-8">
          <h1 className="text-2xl font-semi-bold">{organization.name}</h1>
