    ...
    <div className="grid gap-4 md:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Hardware and environment details</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span>{emissionTimeSeries.metadata.ram_total_size} GB</span>
            </div>
            <div>
          ...
          <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
            <div className="flex flex-row items-center justify-between">
              ...
              {!isPublicView && (
                <ExportCsvButton
                  isDisabled={
                    !emissionTimeSeries || !emissionTimeSeries.emissions.length
                  }
                  onDownload={async () => {
          ...
          >
            ...
            >
              ...
              <XAxis
                ...
                tickMargin={8}
                minTickGap={48}
                tickFormatter={(value) => format(new Date(value), tickFmt)}
              />
                ...
                content={
                  <ChartTooltipContent
                    ...
                    labelFormatter={(_, payload) => {
                      ...
                      return format(new Date(point.ts), "MMM d, yyyy HH:mm:ss");
                    }}
                  />
                }
              />
