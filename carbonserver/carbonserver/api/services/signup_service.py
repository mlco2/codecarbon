...
class SignUpService:
    def __init__(
        ...
        self._default_org_id = "e52fe339-164d-4c2b-a8c0-f562dfce066d"
        self._default_team_id = "8edb03e1-9a28-452a-9c93-a3b6560136d7"
    ...
    def subscribe_user_to_team(self, user: User, team_id: str, team_api_key: str):
        joined = False
