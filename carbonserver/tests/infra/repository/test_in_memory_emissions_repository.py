...
from carbonserver.api.domain.models import Emission as ModelEmission

from carbonserver.api.infra.repository.repository_emissions import InMemoryRepository
...
def test_emissions_repository_saves_correct_emission(emissions_repository, model_emission):
    emission = EmissionCreate.parse_obj({
        "timestamp": "2021-04-04T08:43:00+02:00",
        "experiment_id": "40088f1a-d28e-4980-8d80-bf5600056a14",
        "duration": 98745,
...
def test_emissions_repository_get_db_to_class_returns_correct_object_type(emissions_repository, model_emission):
...
def test_get_one_emission_returns_the_correct_emission_from_emission_id(emissions_repository, emission_fixture):
    emission_id = 1
...
def test_get_one_emission_returns_the_correct_emission_list_from_experiment_id(emissions_repository, emission_fixture):
    experiment_id = "40088f1a-d28e-4980-8d80-bf5600056a14"
    expected_emissions = [SchemaEmission.parse_obj({
        "id": 1,
        "timestamp": "2021-04-04T08:43:00+02:00",
        "experiment_id": "40088f1a-d28e-4980-8d80-bf5600056a14",
        "duration": 98745,
